...
; filename CANACC5_v2j.asm  18/05/12  
...
; Derived from CANACC8_v2a
;Rev v2a    First release build
;Rev v2b    Use evehndlr_c.asm
;Rev v2c    Correct module Id
;Rev v2d    add call to rdfbev in rdbak
;Rev v2e    change reply to QNN to OPC_PNN
;Rev v2f    Add check for zero index in read parameters and correct error code
;Rev v2g    Include file now evhndlr_d.asm
;Rev v2h    Include file now evhndlr_e.asm, remove NEVER compiled code
;Rev v2j    Change parameters to new format
...
;Para5  equ   EV_NUM
;Para6  equ   NV_NUM
;Para7  equ .2        ; development build, not for release
