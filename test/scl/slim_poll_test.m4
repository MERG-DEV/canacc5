...
beginning_of_test(17)
    begin_test
     ...
     --
      ...
      tx_wait_for_node_message(OPC_ARSOF, 0, 0, 101, EN high, 70, EN low) -- ARSOF, CBUS short off poll response
      --
      ...
      tx_wait_for_node_message(OPC_ARSON, 0, 0, 101, EN high, 70, EN low) -- ARSOF, CBUS short off poll response
end_of_test
